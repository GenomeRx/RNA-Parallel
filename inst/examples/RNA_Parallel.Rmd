...
Each original was timed twice, once before the companion arms and once after, and the mean of the
two is the denominator. The two readings differ by at most
`r sprintf("%.1f%%", 100 * sim_drift)`, which is the measurement noise every speedup here carries.
...
Originals were bracketed as in C.2, once before the companion arms and once after, and the two
readings differ by at most `r sprintf("%.1f%%", 100 * limma_drift)`.
