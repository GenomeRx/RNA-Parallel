...
follows. None of them reimplements a method from its description: the original is called unchanged on blocks of genes or
samples, with at most a symbol rebound in a child of the original's own environment.
...
only the arithmetic after the trend splits. `contrasts.fit` is exactly splittable and the original
